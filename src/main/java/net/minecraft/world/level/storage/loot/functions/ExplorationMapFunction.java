...
public class ExplorationMapFunction extends LootItemConditionalFunction {
    ...
    ExplorationMapFunction(LootItemCondition[] conditions, TagKey<Structure> destination, MapDecoration.Type decoration, byte zoom, int searchRadius, boolean skipExistingChunks) {
        super(conditions);
    ...
    public static class Serializer extends LootItemConditionalFunction.Serializer<ExplorationMapFunction> {
        ...
        public void serialize(JsonObject json, ExplorationMapFunction object, JsonSerializationContext context) {
            ...
            if (!object.destination.equals(ExplorationMapFunction.DEFAULT_DESTINATION)) {
        ...
        private static TagKey<Structure> readStructure(JsonObject json) {
