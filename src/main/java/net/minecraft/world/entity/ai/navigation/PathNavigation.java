...
public abstract class PathNavigation {
    ...
    protected static boolean isClearForMovementBetween(Mob entity, Vec3 startPos, Vec3 entityPos) {
        Vec3 vec3 = new Vec3(entityPos.x, entityPos.y + (double)entity.getBbHeight() * 0.5D, entityPos.z);
        return entity.level.clip(new ClipContext(startPos, vec3, ClipContext.Block.COLLIDER, ClipContext.Fluid.NONE, entity)).getType() == HitResult.Type.MISS;
    }
